...
2. 한개의 방정식의 양변에 0이 아닌 상수를 곱한 것을 다른방정식의 양변에 각각 더하기  3. 방정식의 위치를 바꾸기
...
- 부교재 @math2020ml 의 2.3.1 Particular and General Solution 절을 반드시 학습하세요
...
다시 @eq-exam-eq-1 에서 제시된 방정식을 열벡터의 선형조합의 형태로 아래와 같이 써보자
